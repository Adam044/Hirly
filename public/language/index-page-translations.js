...
if (typeof window.addTranslations === 'function') {
    window.addTranslations({
        ...
        'freelancer_login_modal_title': { 'ar': 'تسجيل الدخول كمهني', 'en': 'Login as Professional' },
        'freelancer_login_modal_desc': { 'ar': 'يجب عليك تسجيل الدخول كمهني لعرض ملفات تعريف الشركات والتقديم على الوظائف.', 'en': 'You must log in as a professional to view company profiles and apply for jobs.' },
        ...
        'login_as_freelancer_icon_desc': { 'ar': 'أيقونة تسجيل الدخول كمهني', 'en': 'Professional Login Icon' },
        'freelancer_profile_restriction_modal_title': { 'ar': 'الوصول مقيد', 'en': 'Access Restricted' },
        'freelancer_profile_restriction_modal_desc': { 'ar': 'كمهني، لا يمكنك عرض ملفات تعريف المهنيين الآخرين. هذه الميزة متاحة لأصحاب العمل.', 'en': 'As a professional, you cannot view other professional profiles. This feature is available for employers.' },
        ...
        'ecosystem_users_desc': { 'ar': 'يبني الباحثون عن عمل والمستقلون والمهنيون صفحة مهنية عامة واحدة تُستخدم في التقديم للوظائف، عرض الخدمات، ومشاركة الهوية المهنية مع أي جهة.', 'en': 'Job seekers and professionals build one public page they reuse for job applications, services, and sharing their career identity anywhere.' },
